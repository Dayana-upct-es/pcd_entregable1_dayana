...
Upct = Universidad()
#Upct.añadir_asignatura('Matematicas', 1234, 6)
Upct.matricular_alumno(1, 'Laura', '23303508T', 'Calle 2033', 'M')
print(len(Upct.listado_alumnos))
#Upct.DarBaja_alumno(1, 'Laura', '23303500T', 'Calle 2033', 'M')
#asignatura = Asignatura('lengua', 2345, 240)
#print(asignatura)
Upct.graduar_alumno(1, 'Laura', '23303508T', 'Calle 2033', 'M')
#persona= Persona('dana', 'X6523798F', 'Calle 2nef', 'M')
...
estudiante2 = Estudiante(
    ...
    sexo="H")
estudiante2.matricular_asignaturas('lengua')
estudiante2.matricular_asignaturas('Mates')
print(estudiante2)
...
profesor_asociado1 = ProfesorAsociado(
    ...
    sexo="M")
profesor_asociado1.asignar_asignatura('lengua')
profesor_asociado1.asignar_asignatura('mates')
print(profesor_asociado1)


'''
    def DarBaja_alumno(self, curso:int, nombre:str, DNI:str, direccion:str, sexo:str):
        alumno_encontrar = Estudiante(curso, nombre, DNI, direccion, sexo)
        alumno_encontrado = False
        for alumno in self.listado_alumnos:
            if alumno_encontrar.DNI == alumno.DNI:
                self.listado_alumnos.remove(alumno)
                alumno_encontrado = True
                print(f"Se ha dado de baja al alumno con DNI: {DNI}")
                break  # Salir del bucle una vez que se elimine el alumno
            ...
            if alumno_encontrar.DNI == alumno.DNI:
                ...
                if alumno.creditos == 240:
                    ...
                    break  # Salir del bucle una vez que se elimine el alumno
                     ...
                     print(f"Creditos insuficientes")
